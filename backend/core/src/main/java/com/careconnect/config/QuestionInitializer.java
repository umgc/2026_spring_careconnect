...
public class QuestionInitializer {
  ...
  @PostConstruct
    ...
    try {
      ...
      log.info("Ã°Å¸â€â€ž Initializing Virtual Check-In questions...");
      ...
      log.info("Ã¢Å“â€¦ Successfully initialized {} Virtual Check-In questions", finalCount);

    } catch (Exception e) {
      // Log the error but don't fail application startup
      log.error("Ã¢ÂÅ’ Failed to initialize questions: {}", e.getMessage(), e);
    }
  }
