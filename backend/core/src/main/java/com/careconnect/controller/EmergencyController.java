...
public class EmergencyController {
  ...
  @Operation(
        summary = "ÃƒÂ°Ã…Â¸Ã…Â¡Ã‚Â¨ Get Emergency PDF",
        ...
        tags = {"Emergency Information", "ÃƒÂ°Ã…Â¸Ã…Â¡Ã‚Â¨ Emergency Response"}
    )
  @ApiResponses({
  ...
  @Operation(
        summary = "ÃƒÂ¢Ã‚Â¬Ã¢â‚¬Â¡ÃƒÂ¯Ã‚Â¸Ã‚Â Download Emergency PDF",
  ...
  @GetMapping("/health")
  @Operation(
        summary = "ÃƒÂ°Ã…Â¸Ã‚ÂÃ‚Â¥ Emergency Service Health Check",
  ...
  @Operation(
        summary = "ÃƒÂ°Ã…Â¸Ã‚ÂÃ¢â‚¬Âº Debug Patient Data",
        description = "Debug endpoint to check if patient data can be retrieved for an emergency ID",
        tags = {"Emergency Information", "ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂºÃ‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â Development"}
    )
