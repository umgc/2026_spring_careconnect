...
public class PatientController {
  ...
  @Operation(
      summary = "Ã°Å¸â€˜Â¨Ã¢â‚¬ÂÃ°Å¸â€˜Â©Ã¢â‚¬ÂÃ°Å¸â€˜Â§Ã¢â‚¬ÂÃ°Å¸â€˜Â¦ Get my family members",
      description = "Retrieve all family members linked to the current patient",
      tags = {"Patient Management", "Ã°Å¸â€˜Â¨Ã¢â‚¬ÂÃ°Å¸â€˜Â©Ã¢â‚¬ÂÃ°Å¸â€˜Â§Ã¢â‚¬ÂÃ°Å¸â€˜Â¦ Family Members"}
  )
  @ApiResponses({
  ...
  @GetMapping("/me")
  @Operation(
      summary = "Ã°Å¸â€˜Â¤ Get my patient profile",
  ...
  @Operation(
      summary = "Ã°Å¸â€œÅ  Create mood & pain log entry",
      ...
      tags = {"Patient Management", "Ã°Å¸â€œÅ  Mood & Pain Tracking"}
  )
  @ApiResponses({
  ...
  @Operation(
      summary = "Ã°Å¸â€œâ€¹ Get all mood & pain logs",
  ...
  @Operation(
      summary = "Ã°Å¸â€œË† Get mood & pain analytics",
