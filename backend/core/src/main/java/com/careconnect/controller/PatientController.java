...
public class PatientController {
    ...
    private User getCurrentUser() {
        ...
        // If no auth (or anonymous), treat as not authenticated
    ...
    public ResponseEntity<MedicationDTO> addMedication(
        ...
        MedicationDTO medicationWithPatientId = MedicationDTO.builder()
                ...
                .isActive(false) // approval flow starts pending
