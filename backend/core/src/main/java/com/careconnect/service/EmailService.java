...
public class EmailService {
  ...
  private void sendEmail(String recipientEmail, String subject, String htmlContent, String textContent) {
    try {
      ...
      System.err.println("ÃƒÂ¢Ã‚ÂÃ…â€™ Failed to send email via " + emailProvider + ": " + e.getMessage());
      e.printStackTrace();
      ...
      if (!"console".equals(emailProvider) && !"dev".equals(emailProvider)) {
        // System.out.println("ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ¢â‚¬Å¾ Falling back to console mode...");
        sendConsoleEmail(recipientEmail, subject, textContent);
      }
    }
  }
  ...
  private void sendConsoleEmail(final String recipientEmail, final String subject, final String content) {
    System.out.println("ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â§ DEV MODE - Email logged to console:");
  ...
  private void sendResendEmail(String recipientEmail, String subject, String htmlContent) {
    ...
    try {
      ...
      if (response.getStatusCode().is2xxSuccessful()) {
                // System.out.println("ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Email sent via Resend to " + recipientEmail);
      } else {
  ...
  private void sendMailgunEmail(String recipientEmail, String subject, String htmlContent) {
    ...
    try {
      ...
      if (response.getStatusCode().is2xxSuccessful()) {
                // System.out.println("ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ Email sent via Mailgun to " + recipientEmail);
      } else {
  ...
  private void sendSmtpEmail(String recipientEmail, String subject, String htmlContent) {
    ...
    if (fromEmail == null || fromEmail.trim().isEmpty()) {
      System.err.println("ÃƒÂ¢Ã‚ÂÃ…â€™ ERROR: fromEmail is null or empty! Check your environment variables and application.properties mapping.");
    ...
    try {
      ...
      System.err.println("ÃƒÂ¢Ã‚ÂÃ…â€™ SMTP Email failed. FROM_EMAIL: '" + fromEmail + "'");
