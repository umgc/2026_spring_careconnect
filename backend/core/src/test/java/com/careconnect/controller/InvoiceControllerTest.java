...
class InvoiceControllerTest {
    ...
    private InvoiceController controller() throws Exception {
        return new InvoiceController(invoiceService, textractService, llmExtractionService, objectMapper, securityUtil, authorizationService);
    }

    // Helper: controller with textract=null (AWS disabled)
    private InvoiceController controllerNoTextract() throws Exception {
        return new InvoiceController(invoiceService, null, null, objectMapper, securityUtil, authorizationService);
    }
